...
const checks = [
  ...
  },
  {
    ...
    assertions: [
      ...
      {
        name: 'todo entry uses framework badge for notice count',
        test: source => source.includes('<wd-badge class="notice-button__badge-wrap"') && !source.includes('notice-button__badge"') && !/\.notice-button__badge\s*\{/.test(source),
      },
    ],
  },
  {
    ...
    assertions: [
      ...
      {
        name: 'archive entry uses framework icons and badge instead of hand-drawn controls',
        test: source => source.includes('<wd-badge class="notice-button__badge-wrap"') && source.includes('<MobileIcon') && /<wd-icon[\s\S]*name="chevron-right"/.test(source) && !source.includes('notice-button__bell') && !source.includes('notice-button__badge"') && !source.includes('category-icon--') && !source.includes('record-icon::before') && !source.includes('search-icon::after') && !source.includes('mic-icon::before'),
      },
    ],
  },
  {
    ...
    assertions: [
      ...
      {
        name: 'profile entry uses framework icons and progress instead of hand-drawn controls',
        test: source => source.includes('<MobileIcon') && source.includes('<wd-progress') && source.includes('<wd-icon class="menu-row__arrow"') && !source.includes('setting-button__gear') && !source.includes('ability-track') && !source.includes('report-visual__') && !source.includes('menu-icon--') && !source.includes('service-icon--'),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    assertions: [
      ...
      },
      {
        ...
        test: source => /\.all-todo-page\s*\{[\s\S]*padding-bottom: calc\(150rpx \+ env\(safe-area-inset-bottom\)\)/.test(source) && /<wd-tabs[\s\S]*class="filter-row"/.test(source) && /\.filter-row :deep\(\.wd-tabs__nav-item\)\s*\{[\s\S]*border-radius: 16rpx/.test(source) && /\.todo-list-card\s*\{[\s\S]*padding: 32rpx/.test(source) && /\.todo-list-card\s*\{[\s\S]*border-radius: 32rpx/.test(source) && /\.todo-title\s*\{[\s\S]*font-size: 32rpx/.test(source),
      },
      {
        name: 'todo all uses framework tabs instead of hand-written filter pills',
        test: source => source.includes('<wd-tabs') && source.includes('<wd-tab') && !source.includes('filter-pill') && !source.includes('filter-pill--active'),
      },
    ],
  },
  {
    ...
    assertions: [
      ...
      {
        name: 'todo dynamics uses framework tabs popup and arrows instead of hand-drawn controls',
        test: source => source.includes('<wd-tabs') && source.includes('<wd-popup') && source.includes('<wd-icon class="dynamic-arrow"') && source.includes('<wd-icon name="close"') && !source.includes('filter-overlay') && !source.includes('drawer-close::before') && !source.includes('drawer-close::after') && !/\.dynamic-arrow\s*\{[^}]*border-top/.test(source),
      },
    ],
  },
  {
    ...
    assertions: [
      ...
      },
      {
        ...
        test: source => /\.dynamics-filter-page\s*\{[\s\S]*padding-bottom: calc\(150rpx \+ env\(safe-area-inset-bottom\)\)/.test(source) && /\.dynamic-card\s*\{[\s\S]*border-radius: 24rpx/.test(source) && /\.filter-drawer\s*\{[\s\S]*border-radius: 48rpx 48rpx 0 0/.test(source) && /\.option-radio :deep\(\.wd-radio__label\)\s*\{[\s\S]*height: 76rpx/.test(source) && /\.drawer-action\s*\{[\s\S]*height: 80rpx/.test(source),
      },
      {
        name: 'todo dynamics filter uses framework tabs popup radio icons and arrows',
        test: source => source.includes('<wd-tabs') && source.includes('<wd-popup') && source.includes('<wd-radio-group') && source.includes('<wd-radio') && source.includes('<wd-icon class="dynamic-arrow"') && source.includes('<wd-icon name="close"') && !source.includes('option-pill') && !source.includes('filter-overlay') && !source.includes('filter-tab--active') && !source.includes('drawer-close::before') && !source.includes('drawer-close::after') && !/\.dynamic-arrow\s*\{[^}]*border-top/.test(source),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    assertions: [
      ...
      },
      {
        ...
        test: source => /\.record-query-page\s*\{[\s\S]*padding: calc\(var\(--status-bar-height\) \+ 16rpx\) 28rpx calc\(170rpx \+ env\(safe-area-inset-bottom\)\)/.test(source) && /\.search-box\s*\{[\s\S]*border-radius: 24rpx/.test(source) && /<wd-tabs[\s\S]*class="filter-tabs"/.test(source) && /\.filter-tabs :deep\(\.wd-tabs__nav-item\)\s*\{[\s\S]*height: 62rpx/.test(source) && /\.record-card\s*\{[\s\S]*padding: 24rpx/.test(source) && /\.record-card\s*\{[\s\S]*border-radius: 26rpx/.test(source),
      },
      {
        name: 'archive record query uses framework search filters tags and arrows',
        test: source => source.includes('<wd-tabs') && source.includes('<wd-tag') && source.includes('<MobileIcon') && source.includes('<wd-icon class="record-arrow"') && !source.includes('record-icon__glyph') && !source.includes('record-tag--') && !/\.record-arrow\s*\{[\s\S]*border-top/.test(source),
      },
    ],
  },
  {
    ...
    assertions: [
      ...
      {
        name: 'archive category uses framework tags and arrows instead of hand-drawn controls',
        test: source => source.includes('<wd-tag') && source.includes('<MobileIcon') && source.includes('<wd-icon class="record-arrow"') && !source.includes('focus-pill--') && !source.includes('record-dot--') && !/\.record-arrow\s*\{[\s\S]*border-top/.test(source),
      },
    ],
  },
  {
  ...
  },
  {
    ...
    assertions: [
      ...
      },
      {
        ...
        test: source => /\.archive-record-list-page\s*\{[\s\S]*padding: calc\(var\(--status-bar-height\) \+ 4rpx\) 30rpx calc\(170rpx \+ env\(safe-area-inset-bottom\)\)/.test(source) && /\.summary-card,\s*[\s\S]*\.empty-card\s*\{[\s\S]*border-radius: 30rpx/.test(source) && /\.record-card\s*\{[\s\S]*padding: 30rpx/.test(source) && /\.record-title\s*\{[\s\S]*font-size: 32rpx/.test(source) && /<wd-tabs[\s\S]*class="toolbar-tabs"/.test(source) && /\.toolbar-tabs :deep\(\.wd-tabs__nav-item\)\s*\{[\s\S]*height: 58rpx/.test(source),
      },
      {
        name: 'archive record list uses framework tabs instead of hand-written toolbar chips',
        test: source => source.includes('<wd-tabs') && source.includes('<wd-tab') && !source.includes('toolbar-chip') && !source.includes('toolbar-chip--active'),
      },
    ],
  },
  {
