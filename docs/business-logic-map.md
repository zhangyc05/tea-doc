...
| 对象 | 说明 | 当前代码位置 |
| --- | --- | --- |
| 我的主页 | 教师个人入口、能力画像摘要、发展报告摘要、档案记录和系统服务入口 | `teacher-mobile/src/pages/profile/index.vue` |
| 能力画像 | 教师个人发展指数、能力等级、维度分布、短板提示和推荐方向 | `teacher-mobile/src/pages/profile/ability-profile/index.vue` |
| 画像用到的记录 | 能力画像引用的档案记录、档案分类、引用维度、引用原因和证据强度 | `teacher-mobile/src/pages/profile/ability-profile/records/index.vue` |
| 个人发展报告 | 个人发展周期、报告状态、能力摘要、依据记录和建议行动 | `teacher-mobile/src/pages/profile/development-report/index.vue` |
| 目标岗位对照 | 目标岗位、能力匹配度、已满足要求、缺口要求、证据入口和建议行动 | `teacher-mobile/src/pages/profile/target-position/index.vue` |
| 聘期要求对照 | 当前聘期、总体完成度、风险数量、已完成证据、缺失证据和建议行动 | `teacher-mobile/src/pages/profile/tenure-requirement/index.vue` |
...
| 页面 | 动作 | 当前实现 | 闭环判断 |
| --- | --- | --- | --- |
| 我的主页 | 查看画像 | `uni.navigateTo('/pages/profile/ability-profile/index')` | 已闭环到能力画像页 |
| 我的主页 | 查看报告 | `uni.navigateTo('/pages/profile/development-report/index')` | 已闭环到个人发展报告页 |
| 能力画像 | 查看画像记录 | `uni.navigateTo('/pages/profile/ability-profile/records/index?from=ability-profile')` | 已闭环到画像用到的记录页 |
